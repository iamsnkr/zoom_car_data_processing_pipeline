...
staging_customers_delta = dbutils.widgets.get("staging_customers_delta")
...
display(VerificationResult.checkResultsAsDataFrame(spark, bookings_verification))
display(VerificationResult.checkResultsAsDataFrame(spark, customers_verification))
...
# Target Delta Tables information
bookings_delta_table = dbutils.widgets.get("bookings_delta_table")
customers_delta_table = dbutils.widgets.get("customers_delta_table")
